...
object EpisodeMapper {
    ...
    fun buildFrom(networkEpisode: GetEpisodeByIdResponse, networkCharacters: List<GetCharacterByIdResponse> = emptyList()): Episode {
        return Episode(
            ...
            characters = networkCharacters.map { CharacterMapper.buildFrom(it) }
            )
    }
